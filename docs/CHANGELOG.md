...
- Added cold memory pruning controls and protected memory topics so users can cap cold surrogate age/count while keeping selected daily memory topics uncompressed from the Settings Memory panel.
